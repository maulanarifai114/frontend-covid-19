...
export default function Today(props) {
  return (
    <div className="row wrap-box">
      ...
      <div className="col-lg d-flex flex-column box-data box-secure">
      ...
      <div className="col-lg d-flex flex-column box-data box-death">
        <h3 className="box-title box-title-death">Meninggal Dunia</h3>
